...
public final class ClusterInstanceGroupImpl extends AbstractClusterGroup {
    ...
    public ClusterInstanceGroupImpl(String name, PlatformGroupDisplay platform, String[] nodes, int minMemory, int maxMemory, boolean staticService, int minOnlineServerInstances, int maxOnlineServerInstances) {
