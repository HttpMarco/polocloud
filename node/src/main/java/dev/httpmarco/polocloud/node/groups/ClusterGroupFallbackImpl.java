...
public class ClusterGroupFallbackImpl extends ClusterGroupImpl implements FallbackClusterGroup {
    ...
    public ClusterGroupFallbackImpl(@NotNull ClusterGroup group) {
        super(group.name(), group.platform(), group.templates(), group.nodes(), group.maxMemory(), group.maxPlayers(), group.staticService(), group.minOnlineServerInstances(), group.maxOnlineServerInstances(), group.properties());
    }
}
