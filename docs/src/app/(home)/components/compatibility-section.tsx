...
export function CompatibilitySection() {
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <motion.div 
        className="absolute top-20 left-10 w-32 h-32 bg-primary/5 rounded-full blur-3xl animate-pulse"
      ...
      />
      <motion.div 
        className="absolute bottom-20 right-10 w-40 h-40 bg-primary/5 rounded-full blur-3xl animate-pulse delay-1000"
        initial={{ opacity: 0, scale: 0, rotate: -180 }}
        whileInView={{ opacity: 1, scale: 1, rotate: 0 }}
        viewport={{ once: true, amount: 0.3 }}
      ...
      />
      <motion.div 
        className="absolute top-1/2 left-1/4 w-24 h-24 bg-primary/3 rounded-full blur-2xl animate-pulse"
      ...
      <div className="relative container mx-auto px-6">
        ...
        >
          ...
          >
            ...
            <motion.span 
              className="block mt-2 text-sm md:text-base font-normal"
      ...
      <motion.div 
        className="absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-background via-background/95 via-background/80 to-transparent"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true, amount: 0.3 }}
