            ...
            <div className="container mx-auto px-6 py-12">
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="text-center">
                        <div className="flex items-center justify-center gap-3 mb-2">
                            ...
                            />
                            <h3 className="text-lg font-bold text-foreground dark:text-white">PoloCloud</h3>
                        </div>
                    ...
                    <div className="flex items-center gap-6">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-muted-foreground dark:text-white/60 hover:text-foreground dark:hover:text-white transition-all duration-300 hover:scale-105 transform"
                        >
                            GitHub
                        </a>
                        <Link
                ...
                <div className="mt-8 pt-8 border-t border-border/30 dark:border-white/10">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground dark:text-white/50">
                        <span>&copy; 2025 PoloCloud. All rights reserved.</span>
