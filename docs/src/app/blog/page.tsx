...
import { Calendar, User, Tag, ArrowRight, Newspaper, Pin } from 'lucide-react';
            ...
            <div className="relative min-h-screen">
                ...
                <div className="container mx-auto px-6 py-12 max-w-6xl relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <h1 className="text-5xl md:text-6xl font-black text-foreground dark:text-white mb-6 leading-tight">
                            PoloCloud Blog
                        </h1>
                    ...
                    {blogPosts.length > 0 && (
                        <div className="mt-16 text-center">
                            <div className="bg-card/30 backdrop-blur-sm border border-border/50 rounded-xl p-8 max-w-2xl mx-auto">
                                <h3 className="text-2xl font-bold text-foreground dark:text-white mb-4">
                                    Stay Updated
                                </h3>
                                <p className="text-muted-foreground mb-6">
                                    Get notified when we publish new blog posts about Minecraft server hosting and PoloCloud updates.
                                </p>
