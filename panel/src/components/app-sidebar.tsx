...
import { NodesSidebarNav } from '@/components/system/sidebar/NodesSidebarNav';
    ...
    <Sidebar collapsible="icon" {...props} variant="inset">
      ...
      <SidebarFooter>
        <div className="flex flex-col list-none">
          <SidebarMenuItem>
            <a href="https://github.com/HttpMarco/polocloud" target="_blank">
              <SidebarMenuButton
                tooltip={'GitHub'}
                className="text-sidebar-foreground/70 fill-foreground"
              >
                <svg
                  role="img"
                  viewBox="0 0 24 24"
